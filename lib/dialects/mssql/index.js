...
Object.assign(Client_MSSQL.prototype, {
  ...
  // SQL Server caps a single statement at 2100 bound parameters; batchUpdate
  // reads this to size its chunks so a wide table can't overflow the default.
  maxBindParameters: 2100,
