...
const batchUpdate = require('../execution/batch-update');
...
function initContext(knexFn) {
  ...
  Object.assign(knexContext, {
    ...
    batchUpdate(table, batch, key = 'id', chunkSize = 1000, options = {}) {
      return batchUpdate(this, table, batch, key, chunkSize, options);
    },
