...
class QueryCompiler_PG extends QueryCompiler {
  ...
  // Postgres needs the VALUES/param columns cast (they are typed `unknown`),
  // and supports RETURNING on UPDATE ... FROM.
  batchUpdate() {
    return this._batchUpdateFromSelect({ cast: true, allowReturning: true });
  }
