...
class Builder extends EventEmitter {
  ...
  // Stashes a batch-update payload compiled by the dialect's
  // `QueryCompiler#batchUpdate`. Used by the `knex.batchUpdate(...)` utility
  // (lib/execution/batch-update.js); not part of the documented chainable API.
  batchUpdate(rows, keyColumns, columns, columnTypes, mode) {
    this._method = 'batchUpdate';
    this._single.batchUpdate = { rows, keyColumns, columns, columnTypes, mode };
    return this;
  }
